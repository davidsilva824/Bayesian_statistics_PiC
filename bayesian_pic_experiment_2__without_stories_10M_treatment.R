...
setwd("C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_berent&pinker/experiment_2_without_stories/10M")
...
m <- brm(Surprisal.head ~ 1 + type * plurality +
         ...
         cores = 4,
         backend = "cmdstanr",
         file = "C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_bayesian_experiment_2_without_stories_10M_treatment")
summary(m)