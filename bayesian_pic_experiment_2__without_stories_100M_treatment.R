...
setwd("C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_berent&pinker/experiment_2_without_stories/100M")

file_list <- c(
  "results_experiment_2_gpt_2_100M.csv",
  "results_experiment_2_babyLlama_100M.csv",
  "results_experiment_2_babble_txt_BPE_with_spaces.csv",
  "results_experiment_2_CLASS_IT.csv",
  "results_experiment_2_OPT_100M.csv",
  "results_experiment_2_gpt_bert_100M_causal.csv",
  "results_experiment_2_gpt_bert_100M_mixed.csv",
  "results_experiment_2_gpt_bert_100M_masked.csv"
)
...
m <- brm(Surprisal.head ~ 1 + type * plurality +
         ...
         cores = 4,
         backend = "cmdstanr",
         file = "C:/Users/Admin/Desktop/Dissertação/código/satistics_PiC/Bayesian_statistics_PiC/results_bayesian_experiment_2_without_stories_100M_treatment")
summary(m)