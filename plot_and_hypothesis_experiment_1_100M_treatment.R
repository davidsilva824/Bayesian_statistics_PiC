...
m <- readRDS("C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_bayesian_experiment_1_100M_treatment.rds")
...
hypothesis(m, "pluralitySingular + regularityIrregular:pluralitySingular = 0") #tests the irrregular plural effect
