...
m <- readRDS("C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_bayesian_experiment_2_without_stories_10M_treatment.rds")
...
#ggsave(
#  "forest_plot_experiment_2_without_stories_10M.png",
#  plot = p,
#  width = 11,
#  height = 7,
#  dpi = 300
