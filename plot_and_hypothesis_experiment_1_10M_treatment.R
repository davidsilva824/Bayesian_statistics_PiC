...
m <- readRDS("C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_bayesian_experiment_1_10M_treatment.rds")
...
#ggsave(
#  "plot_regularity_x_plurality_legend_10M.png",
#  plot = p,
#  width = 4.5,
#  height = 5,
#  dpi = 300
