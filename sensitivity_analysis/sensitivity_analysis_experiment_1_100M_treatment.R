...
setwd("C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/results_experiment_1/100M")
...
sensitivity_results <- lapply(prior_sds, function(prior_sd){
  ...
  m <- brm(Surprisal.head ~ 1 + regularity * plurality +
           ...
           backend = "cmdstanr",
           file = paste0(
             "C:/Users/Admin/Desktop/Dissertação/código/Bayesian_statistics_PiC/sensitivity_analysis/results_bayesean_experiment_1_100M_treatment_prior_",
             prior_sd
           ))
